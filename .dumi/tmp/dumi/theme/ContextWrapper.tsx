...
export default function DumiContextWrapper() {
  ...
  return (
    <SiteContext.Provider value={{
      pkg: {"name":"lighting-design","description":"🎨 Lighting Design 是一款使用 TypeScript + React 编写的实用业务组件库。","version":"2.1.35","license":"MIT","repository":{"type":"git","url":"https://github.com/llq0802/lighting-design"},"author":"李岚清 llq0802 <958614130@qq.com>"},
      historyType: "browser",
      entryExports,
      demos,
      components,
