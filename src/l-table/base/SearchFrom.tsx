...
import { isAntdVersionMoreThan514, uniqueId } from 'lighting-design/utils';
...
const SearchForm = forwardRef(
  ({ formItems: items = [], cardProps, name, loading, isReady, submitter, ...restProps }: SearchFormProps, ref) => {
