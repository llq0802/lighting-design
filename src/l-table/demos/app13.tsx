import { Button, ConfigProvider, Flex, Tag, Watermark } from 'antd';
...
const formItems = [
  ...
  <LFormItemDate rangePicker key="6" name="date6" label="时间项" disabledDateBefore={1} />,
];
  ...
  return (
    <ConfigProvider
      theme={{
        components: {
          Flex: {
            colorBgContainer: '#1b3160', // flex组件的背景颜色
          },
          Table: {
          ...
          Pagination: {
            ...
            colorPrimary: '#fff', //
            colorBgContainer: '#1a2a52', // 组件背景颜色
          },
          Button: {
    ...
    >
      <Watermark content="Lighting Design" font={{ fontSize: 16, color: 'rgba(0,0,0,.35)' }}>
        <LTable
          rowKey="id"
          rowHoverable="#426396"
          rowStripe="#152a52"
          ...
          request={async (params, type) => {
            ...
            return await apiGetUserList(params, 60);
          }}
        />
      </Watermark>
    </ConfigProvider>
