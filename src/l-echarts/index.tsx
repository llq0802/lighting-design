...
import { fastDeepClone, isFunction, transformEchartsOption } from 'lighting-design/utils';
...
const LECharts: FC<LEChartsProps> = memo((props) => {
  ...
  /** 绑定图表实例事件 */
  const bindEvents = useMemoizedFn((instance: ECharts, events: Record<string, (params: any, ins: ECharts) => void>) => {
