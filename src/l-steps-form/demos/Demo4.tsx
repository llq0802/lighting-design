  ...
  return (
    <div>
      ...
      >
        ...
        >
          <LFormItemInput name="phone1" label="手机号1" required tooltip="禁止空格 只能输入数字" type="phone" />
          <LFormItemInput name="phone2" label="手机号2" required tooltip="禁止空格 只能输入数字" type="phone2" />
        </LStepsForm.StepForm>
      </LStepsForm>
    </div>
  );
