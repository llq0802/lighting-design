  ...
  return (
    <div style={{ height: 900 }}>
      <Row style={{ background: `url(${loginBg}) no-repeat`, height: '100%' }}>
        <Col flex="1" className="login_col">
          <div className="login_intro">
            <h1>Lighting Design</h1>
            <div className="desc">
              基于React、TypeScript、Ant
              Design、UmiJs、ahook等开发的后台模板组件。 lighting-design 是基于
              Ant Design UI
              而开发的业务常用模板组件，提供了更高级别的抽象支持，开箱即用。可以显著的提升制作
              CRUD 页面的效率，更加专注于页面开发。
            </div>
        ...
        <Col
          style={{ minWidth: '36%', flexWrap: 'nowrap' }}
          className={'login_from_col'}
        >
          <LLoginForm
